...
```{r high_power_univariate_ladder, results='hide', cache=FALSE}
rm(list=ls())
require("DiceEnterprise")
...
```{r high_power_univariate_ladder_print}
#Prepare output
...
```{r high_power_multivariate_ladder, results='hide', cache=FALSE}
rm(list=ls())
require("DiceEnterprise")
...
```{r high_power_multivariate_ladder_print}
#Prepare output
